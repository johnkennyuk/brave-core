...
#include "bat/ads/internal/ad_targeting/data_models/purchase_intent/purchase_intent_components.h"
#include "bat/ads/internal/ad_targeting/data_models/text_classification/text_classification_components.h"
...
void AdsImpl::OnUserModelUpdated(
    const std::string& id) {
  if (ad_targeting::kTextClassificationComponentIds.find(id) !=
      ad_targeting::kTextClassificationComponentIds.end()) {
    text_classification_resource_->LoadForId(id);
  } else if (ad_targeting::kPurchaseIntentComponentIds.find(id) !=
      ad_targeting::kPurchaseIntentComponentIds.end()) {
